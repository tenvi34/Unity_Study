Shader "EGA/Particles/FireSphere"
{
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutput o)
        {
            ...
            float2 temp_output_8_0 = (((float2(0.2, 0) * _Time.y) + (i.uv_tex3coord).xy + i.uv_tex3coord.z) *
                _StartFrequency);
            ...
            float lerpResult38 = lerp(frac((473.5 * sin((57.0 + temp_output_21_0)))),
                                                            frac((473.5 * sin((58.0 + temp_output_21_0)))),
                                                            break17.x);
            float lerpResult40 = lerp(lerpResult39, lerpResult38, break17.y);
            float3 temp_output_51_0 = ((float3((float2(0.5, 0.5) * _Time.y), 0.0) + (i.uv_tex3coord * (lerpResult40 *
            ...
            float lerpResult105 = lerp(frac((473.5 * sin((57.0 + temp_output_90_0)))),
            ...
            float4 clampResult132 = clamp((i.vertexColor.a * tex2DNode117 * _Opacity), float4(0, 0, 0, 0),
                                                               float4(1, 1, 1, 1));
